...
**Multi-version CI**: Tests and development tool installation are validated across multiple PHP and Node.js versions and operating systems (Debian, Ubuntu, Alpine).

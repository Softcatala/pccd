...
final class PageRenderer
{
    ...
    {
        self::$title = prepare_text_for_html($title, escape_html: false, end_with_dot: false);
    }
 ...
 */
function prepare_text_for_html(string $input, bool $escape_html = true, bool $end_with_dot = true): string
{

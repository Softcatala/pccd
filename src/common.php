...
final class PageRenderer
{
    ...
    public function printCss(): void
    {
        ...
        if (file_exists($page_css_file)) {
            readfile($page_css_file);
        } else {
            readfile(__DIR__ . '/../docroot/css/base.min.css');
        }
    }
    ...
    public function printJs(): void
    {
        ...
        if (file_exists($page_js_file)) {
            readfile($page_js_file);
        }

        readfile(__DIR__ . '/../docroot/js/app.min.js');
    }
...
{
    // This is not a security-sensitive operation, so rand() is sufficient.

...
{
    $og_slug = route_og_request();
    if ($og_slug !== null) {
        render_og_image_and_exit($og_slug);
    }
...
/**
 * Routes and handles OG image requests based on REQUEST_URI.
 *
 * Returns the paremiotipus slug if this is an OG image request, or null otherwise.
 */
function route_og_request(): ?string
{
    $request_uri = get_request_uri();
 ...
 *
 * See https://news.ycombinator.com/item?id=46574640.
 *

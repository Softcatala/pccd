...
<head>
    ...
    <style>
<?php
// If the page has page-specific CSS (which includes base.css), use it; otherwise fall back to base.css.
if (file_exists(__DIR__ . "/../../docroot/css/pages/{$page->name}.min.css")) {
    require __DIR__ . "/../../docroot/css/pages/{$page->name}.min.css";
} else {

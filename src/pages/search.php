...
$search_query_normalized = get_search_query_normalized($search_mode);
$search_query_input_clean = get_search_query_input_clean();

$where_clause = '';
$arguments = [];
if ($search_query_normalized === '' && !isset($_GET['font'])) {
    ...
    [$where_clause, $arguments] = build_search_sql_query($search_query_normalized, $search_mode);
...
if ($page_count > 1 && $search_query_normalized !== '') {

...
function render_paremiotipus_images_and_set_og_tags(string $paremiotipus_id, string $alt_text): string
{
    ...
    foreach ($images as $image) {
        ...
        $images_content_html .= '<div class="bloc bloc-image text-break"><figure>';
        ...
        if ($image->DIARI !== '' && $image->DIARI !== $image->AUTOR) {
            ...
            if ($image_link_url !== '' && $image->ARTICLE === '') {
                $diari = '<a href="' . $image_link_url . '" class="external" target="_blank" rel="noopener">' . $diari . '</a>';
            }
        ...
        if ($image->ARTICLE !== '') {
            ...
            if (str_contains($image->ARTICLE, 'http')) {
                $article_html = html_escape_and_link_urls($image->ARTICLE);
            } else {
                $article_html = htmlspecialchars($image->ARTICLE);
                if ($image_link_url !== '') {
                    $article_html = '<a href="' . $image_link_url . '" class="external" target="_blank" rel="noopener">' . $article_html . '</a>';
                }
            }
        ...
        if ($image_caption !== '') {
            $images_content_html .= '<figcaption class="small">' . $image_caption . '</figcaption>';
        }
        $images_content_html .= '</figure></div>';
    }

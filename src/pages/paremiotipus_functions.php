...
function render_paremiotipus_images_and_set_og_tags(string $paremiotipus_id, string $alt_text): string
{
    ...
    foreach ($images as $image) {
        ...
        if ($is_first_processed_image) {
            ...
            PageRenderer::setMetaImage(BASE_URL . '/img/imatges/' . rawurlencode($image->Identificador));
        }
...
function render_share_icons(string $share_url, string $title): string
{
    ...
    $output .= '<button type="button" id="share">Comparteix <svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M17 22q-1.3 0-2.1-.9T14 19v-.7l-7-4.1q-.4.4-.9.6T5 15q-1.3 0-2.1-.9T2 12t.9-2.1T5 9q.6 0 1.1.2t1 .6l7-4.1v-.3L14 5q0-1.3.9-2.1T17 2t2.1.9T20 5t-.9 2.1T17 8q-.6 0-1.1-.2t-1-.6l-7 4.1v.3l.1.4q.1.3 0 .4t0 .3l7 4.1q.4-.4.9-.6T17 16q1.3 0 2.1.9T20 19t-.9 2.1-2.1.9"/></svg></button>';
    $output .= '<div class="share-icons" hidden>';
    $output .= '<span class="close" role="button" tabindex="0" aria-label="Tanca"><svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M6.4 19 5 17.6l5.6-5.6L5 6.4 6.4 5l5.6 5.6L17.6 5 19 6.4 13.4 12l5.6 5.6-1.4 1.4-5.6-5.6z"/></svg></span>';
    $output .= '<a class="share-icon facebook" href="https://www.facebook.com/sharer/sharer.php?u=' . $share_url . '" target="_blank" rel="noopener"><span class="share-image" aria-hidden="true"><svg viewBox="0 0 24 24"><path fill="currentColor" d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c5.05-.5 9-4.76 9-9.95"/></svg></span><span class="share-title">Facebook</span></a>';
    $output .= '<a class="share-icon twitter" href="https://x.com/intent/post?url=' . $share_url . '" target="_blank" rel="noopener"><span class="share-image" aria-hidden="true"><svg viewBox="0 0 24 24"><path fill="currentColor" d="M22.46 6c-.77.35-1.6.58-2.46.69.88-.53 1.56-1.37 1.88-2.38-.83.5-1.75.85-2.72 1.05C18.37 4.5 17.26 4 16 4c-2.35 0-4.27 1.92-4.27 4.29 0 .34.04.67.11.98C8.28 9.09 5.11 7.38 3 4.79c-.37.63-.58 1.37-.58 2.15 0 1.49.75 2.81 1.91 3.56-.71 0-1.37-.2-1.95-.5v.03c0 2.08 1.48 3.82 3.44 4.21a4.2 4.2 0 0 1-1.93.07 4.28 4.28 0 0 0 4 2.98 8.52 8.52 0 0 1-5.33 1.84q-.51 0-1.02-.06C3.44 20.29 5.7 21 8.12 21 16 21 20.33 14.46 20.33 8.79c0-.19 0-.37-.01-.56.84-.6 1.56-1.36 2.14-2.23"/></svg></span><span class="share-title">Twitter</span></a>';
    $output .= '<a class="share-icon whatsapp" href="https://api.whatsapp.com/send?text=' . $share_url . '" target="_blank" rel="noopener"><span class="share-image" aria-hidden="true"><svg viewBox="0 0 24 24"><path fill="currentColor" d="M19.05 4.91A9.82 9.82 0 0 0 12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21 5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.01m-7.01 15.24c-1.48 0-2.93-.4-4.2-1.15l-.3-.18-3.12.82.83-3.04-.2-.31a8.26 8.26 0 0 1-1.26-4.38c0-4.54 3.7-8.24 8.24-8.24 2.2 0 4.27.86 5.82 2.42a8.18 8.18 0 0 1 2.41 5.83c.02 4.54-3.68 8.23-8.22 8.23m4.52-6.16c-.25-.12-1.47-.72-1.69-.81-.23-.08-.39-.12-.56.12-.17.25-.64.81-.78.97-.14.17-.29.19-.54.06-.25-.12-1.05-.39-1.99-1.23-.74-.66-1.23-1.47-1.38-1.72-.14-.25-.02-.38.11-.51.11-.11.25-.29.37-.43s.17-.25.25-.41c.08-.17.04-.31-.02-.43s-.56-1.34-.76-1.84c-.2-.48-.41-.42-.56-.43h-.48c-.17 0-.43.06-.66.31-.22.25-.86.85-.86 2.07s.89 2.4 1.01 2.56c.12.17 1.75 2.67 4.23 3.74.59.26 1.05.41 1.41.52.59.19 1.13.16 1.56.1.48-.07 1.47-.6 1.67-1.18.21-.58.21-1.07.14-1.18s-.22-.16-.47-.28"/></svg></span><span class="share-title">WhatsApp</span></a>';
    $output .= '<a class="share-icon telegram" href="https://t.me/share/?url=' . $share_url . '" target="_blank" rel="noopener"><span class="share-image" aria-hidden="true"><svg viewBox="0 0 24 24"><path fill="currentColor" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2m4.64 6.8c-.15 1.58-.8 5.42-1.13 7.19-.14.75-.42 1-.68 1.03-.58.05-1.02-.38-1.58-.75-.88-.58-1.38-.94-2.23-1.5-.99-.65-.35-1.01.22-1.59.15-.15 2.71-2.48 2.76-2.69a.2.2 0 0 0-.05-.18c-.06-.05-.14-.03-.21-.02-.09.02-1.49.95-4.22 2.79-.4.27-.76.41-1.08.4-.36-.01-1.04-.2-1.55-.37-.63-.2-1.12-.31-1.08-.66.02-.18.27-.36.74-.55 2.92-1.27 4.86-2.11 5.83-2.51 2.78-1.16 3.35-1.36 3.73-1.36.08 0 .27.02.39.12.1.08.13.19.14.27-.01.06.01.24 0 .38"/></svg></span><span class="share-title">Telegram</span></a>';
    $output .= '<a class="share-icon email" href="mailto:?subject=' . rawurlencode($title) . '&amp;body=' . $share_url . '"><span class="share-image" aria-hidden="true"><svg viewBox="0 0 32 32"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M29 9v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9m26 0a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2m26 0-11.862 8.212a2 2 0 0 1-2.276 0L3 9"/></svg></span><span class="share-title">Correu</span></a>';
    $output .= '<a class="share-icon copy" href="#"><span class="share-image" aria-hidden="true"><svg viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M18.327 7.286h-8.044a1.93 1.93 0 0 0-1.925 1.938v10.088c0 1.07.862 1.938 1.925 1.938h8.044a1.93 1.93 0 0 0 1.925-1.938V9.224c0-1.07-.862-1.938-1.925-1.938"/><path d="M15.642 7.286V4.688c0-.514-.203-1.007-.564-1.37a1.92 1.92 0 0 0-1.361-.568H5.673c-.51 0-1 .204-1.36.568a1.95 1.95 0 0 0-.565 1.37v10.088c0 .514.203 1.007.564 1.37s.85.568 1.361.568h2.685"/></g></svg></span><span class="share-title">Enllaç</span></a>';
    $output .= '</div></div>';

...
final readonly class ParemiotipusVariant
{
     ...
     *
     * @return string The paremiotipus ID.
     */
     ...
     *
     * @return string The formatted citation HTML.
     */
     ...
     *
     * @return string The body content HTML.
     */
 ...
 *
 * @param string $input_url The URL to clean and validate.
 *
 * @return string The cleaned URL or empty string if invalid.
 */
 ...
 *
 * @param string $paremiotipus_id The paremiotipus ID to search for variants.
 *
 ...
 *
 * @param string $modisme The modisme to search for.
 *
 * @return string The paremiotipus ID if found, empty string otherwise.
 */
 ...
 *
 * @param string $paremiotipus_id The paremiotipus ID to get images for.
 *
 ...
 *
 * @param string $paremiotipus_id The paremiotipus ID to get mp3 files for.
 *
 ...
 *
 * @param string $input_modisme The paremiotipus/modisme to search.
 *
 * @return string The best matching paremiotipus Id, or an empty string if no matching modisme/paremiotipus is found.
 */
 ...
 *
 * @param string $input_paremiotipus The paremiotipus to validate and redirect if possible.
 */
 ...
 *
 * @param string $paremiotipus_id The paremiotipus ID to get Common Voice files for.
 *
 * @return string The HTML block for Common Voice audio.
 */
 ...
 *
 * @param string $paremiotipus_id The paremiotipus ID to get images for.
 * @param string $alt_text        The alt text for the images.
 *
 * @return string The HTML block for images.
 */
 ...
 *
 * @param string $autor   The author of the image.
 * @param string $any     The year of the image.
 * @param string $diari   The diary or publication.
 * @param string $article The article title.
 * @param string $link    The link to the article or image.
 *
 * @return string The formatted image caption HTML.
 */
 ...
 *
 * @param string $key The column key to extract the language name from.
 *
 * @return string The language name in lowercase.
 */
 ...
 *
 * @param string $paremiotipus_id The paremiotipus ID to get translations for.
 *
 ...
 *
 * @param string $paremiotipus_id The paremiotipus ID to render translations for.
 *
 * @return string The HTML for the translations, or an empty string if none exist.
 */
 ...
 *
 * @return string The HTML for the translations toggle button.
 */
 ...
 * @param string $title     The title to use in sharing.
 *
 * @return string The HTML code for the share icons.
 */

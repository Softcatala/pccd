 ...
 *
 * @return SearchMode The search mode from query parameters or default.
 */
 ...
 *
 * @return SearchMode The computed internal search mode.
 */
 ...
 *
 * @return string The sanitized search query string for HTML output.
 */
 ...
 *
 * @param string $checkbox The checkbox name to check.
 *
 * @return bool True if the checkbox should be checked, false otherwise.
 */
 ...
 *
 * @param int $page_number The page number for the URL.
 *
 * @return string The complete pager URL.
 */
 ...
 *
 * @param int $pagination_limit The current pagination limit.
 *
 * @return string The HTML for the results per page selector.
 */
 ...
 *
 * @return string The HTML for the search mode selector.
 */
 ...
 *
 * @param int        $page_number The page number for this item.
 * @param int|string $text        The text to display in the item.
 * @param string     $title       The title attribute for the item.
 * @param bool       $is_active   Whether this item is the active page.
 *
 * @return string The HTML for the pagination item.
 */
 ...
 *
 * @param int $current_page_number The current page number.
 * @param int $page_count          The total number of pages.
 *
 * @return string The HTML for the complete pagination navigation.
 */
 ...
 *
 * @return bool True if the number requires an apostrophe, false otherwise.
 */
 ...
 *
 * @param int    $offset           The current offset for pagination.
 * @param int    $results_per_page The number of results per page.
 * @param int    $result_count     The total number of results.
 * @param string $search_query     The search query string.
 *
 * @return string The HTML for the search summary.
 */
 ...
 *
 * @param string       $where_clause The SQL WHERE clause to use for counting results.
 * @param list<string> $arguments    The arguments to bind to the SQL query.
 *
 * @return int The number of distinct PAREMIOTIPUS entries matching the search criteria.
 *
 ...
 *
 * @param string       $where_clause The SQL WHERE clause to use for fetching results.
 * @param list<string> $arguments    The arguments to bind to the SQL query.
 * @param int          $limit        The maximum number of results to return.
 * @param int          $offset       The offset from which to start returning results.
 *

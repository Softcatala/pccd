...
(() => {
    ...
    const updateCheckboxState = (checkbox, key) => {
        localStorage.setItem(key, checkbox.checked ? CHECKBOX_MANUALLY_ENABLED : CHECKBOX_MANUALLY_DISABLED);
    };
    variantCheckbox.addEventListener("change", () => updateCheckboxState(variantCheckbox, "variant"));
    sinonimCheckbox.addEventListener("change", () => updateCheckboxState(sinonimCheckbox, "sinonim"));
    equivalentCheckbox.addEventListener("change", () => updateCheckboxState(equivalentCheckbox, "equivalent"));

 ...
 * @param string                 $style   Additional CSS styles for the chart container.
 *
 * @return string The HTML code containing the chart canvas and JavaScript.
 */
 ...
 * @param string       $directory_path The directory path containing the files.
 * @param string       $attribute      The attribute to extract from the JSON.
 *
 ...
 * @param bool   $nobody Whether to use HEAD request only.
 *
 * @return int The HTTP response code, or 0 if failed.
 */
 ...
 *
 * @param string $input_sinonim The raw sinonim string to clean.
 *
 * @return string The cleaned sinonim string.
 */
 ...
 *
 * @param string $sinonim_field The sinonim field containing multiple values.
 *

...
function test_imatges_extensions(): void
{
    ...
    echo '<pre>';
    readfile(__DIR__ . '/../../data/reports/test_imatges_extensions.txt');
    echo '</pre>';

    echo "<h3>Fitxers d'imatge amb extensió no suportada, en majúscules o no estàndard (gif/jpg/png)</h3>";
    echo '<pre>';
    readfile(__DIR__ . '/../../data/reports/test_imatges_file_extensions.txt');
    echo '</pre>';
}
...
function test_imatges_format(): void
{
    ...
    echo '<details><pre>';
    readfile(__DIR__ . '/../../data/reports/test_imatges_petites.txt');
    echo '</pre></details>';

    echo '<h3>Imatges amb possibles problemes de format</h3>';
    echo '<details><pre>';
    readfile(__DIR__ . '/../../data/reports/test_imatges_format.txt');
    echo '</pre></details>';
}
...
function test_imatges_no_existents(): void
{
    ...
    echo '<pre>';
    readfile(__DIR__ . '/../../data/reports/test_imatges_no_existents.txt');
    echo '</pre>';
}
...
function test_imatges_duplicades(): void
{
    ...
    echo '<details><pre>';
    readfile(__DIR__ . '/../../data/reports/test_imatges_duplicades.txt');
    echo '</pre></details>';
}
...
function test_imatges_no_referenciades(): void
{
    ...
    echo '<pre>';
    readfile(__DIR__ . '/../../data/reports/test_imatges_no_referenciades.txt');
    echo '</pre>';
}

...
function test_espais(): void
{
    ...
    echo '<pre>';
    $output = (string) @file_get_contents(__DIR__ . '/../../data/reports/test_intl_paremiotipus_sospitosos.txt');
    ...
    echo '<pre>';
    $output = (string) @file_get_contents(__DIR__ . '/../../data/reports/test_intl_modismes_sospitosos.txt');
    echo $output !== '' ? $output : '(cap resultat)';
    echo '</pre>';

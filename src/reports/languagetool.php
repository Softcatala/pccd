...
function test_languagetool(): void
{
    ...
    $text = @file_get_contents(__DIR__ . '/../../scripts/report-generation/languagetool-checker/excluded_new.txt');
    if ($text !== false) {
    ...
    $text = file_get_contents(__DIR__ . '/../../scripts/report-generation/languagetool-checker/excluded.txt');
    if ($text !== false) {

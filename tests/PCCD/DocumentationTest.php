...
final class DocumentationTest extends TestCase
{
    public function testReadmeHasCorrectPhpMinimumVersion(): void
    {
        ...
        $this->assertStringContainsString($composerPhpVersion, (string) file_get_contents($installationDocPath), "File {$installationDocPath} needs to contain information '{$minimumVersionInformation}'");
    }
    ...
    public function testReadmeHasCorrectNodeJsMinimumVersion(): void
    {
        ...
        $this->assertStringContainsString($minimumVersionInformation, (string) file_get_contents($installationDocPath), "File {$installationDocPath} needs to contain information '{$minimumVersionInformation}'");
    }
}

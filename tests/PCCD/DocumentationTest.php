...
final class DocumentationTest extends TestCase
{
    public function testReadmePhpBadgeUrl(): void
    {
        ...
        $this->assertStringContainsString($expectedBadgeUrl, $this->getReadme(), "README should contain PHP badge URL '{$expectedBadgeUrl}'");
    }
    ...
    public function testReadmePhpBadgeLabel(): void
    {
        ...
        $this->assertStringContainsString("[![PHP {$phpVersion}+]", $this->getReadme(), "README should contain PHP badge label 'PHP {$phpVersion}+'");
    }
    ...
    public function testReadmePhpRequirement(): void
    {
        ...
        $this->assertStringContainsString("- PHP {$phpVersion}+", $this->getReadme(), "README requirements list should contain 'PHP {$phpVersion}+'");
    }
    ...
    public function testReadmeNodeBadgeUrl(): void
    {
        ...
        $this->assertStringContainsString($expectedBadgeUrl, $this->getReadme(), "README should contain Node.js badge URL '{$expectedBadgeUrl}'");
    }
    ...
    public function testReadmeNodeBadgeLabel(): void
    {
        ...
        $this->assertStringContainsString("[![Node.js {$nodeVersion}+]", $this->getReadme(), "README should contain Node.js badge label 'Node.js {$nodeVersion}+'");
    }
    ...
    public function testReadmeNodeRequirement(): void
    {
        ...
        $this->assertStringContainsString("- Node.js {$nodeVersion}+", $this->getReadme(), "README requirements list should contain 'Node.js {$nodeVersion}+'");
    }

/*! This bundle includes simple-datatables 10.0.0 (https://github.com/fiduswriter/simple-datatables). License: https://www.gnu.org/licenses/lgpl-3.0.html */
...
(()=>{const e=window.addEventListener;window.addEventListener=function(a,d,t){"resize"!==a&&e.call(this,a,d,t)},new simpleDatatables.DataTable("#fonts",{columns:[{select:2,sort:"asc"}],labels:{noResults:"No s'ha trobat cap resultat"},locale:"ca",paging:!1,tableRender:(e,a,d)=>{if("print"===d)return a;const t=a.childNodes[0],s={childNodes:t.childNodes[0].childNodes.map(((e,a)=>{const d=e.childNodes.find((e=>"BUTTON"===e.nodeName));return{childNodes:[{attributes:{"aria-label":`Cerca a la columna ${d&&d.childNodes.length>0&&"#text"===d.childNodes[0].nodeName?d.childNodes[0].data:a+1}`,class:"datatable-input","data-and":!0,"data-columns":`[${a}]`,type:"search"},nodeName:"INPUT"}],nodeName:"TH"}})),nodeName:"TR"};return t.childNodes.push(s),a}})})();

...
const directoriesToCheck = [path.join(rootDirectory, "src/images"), path.join(rootDirectory, "docroot/img")];
...
if (hasConflicts) {
  console.log("\n⚠️  These files would conflict on case-sensitive filesystems (Linux)");
  process.exit(1);
} else {

 ...
 */
const downloadOgImage = async (url) => {
 ...
 */
const processUrlsBatch = async (urls, concurrency) => {
  const results = [];
...
// Process all URLs.
const results = await processUrlsBatch(urls, MAX_CONCURRENT);

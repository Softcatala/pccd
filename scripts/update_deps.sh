...
if [[ $1 == "docker" ]]; then
  ...
  check_version_docker_file .docker/nginx.Dockerfile alpine latest
  check_version_docker_file .docker/sql.Dockerfile mariadb lts
  check_version_docker_compose docker-compose.yml mariadb lts
  check_version_docker_compose docker-compose.fpm.yml mariadb lts
  check_version_docker_compose docker-compose.frankenphp.yml mariadb lts
  exit 0
fi

...
const processPng = async (sourceFile, targetFile, width) => {
  ...
  try {
    ...
    if (fileSizeDifferenceBelowThreshold(targetFile, temporaryFile)) {
      // Optimization didn't save enough, discard it.
      fs.unlinkSync(temporaryFile);
    } else {
      // Significant size reduction, use the optimized version.
